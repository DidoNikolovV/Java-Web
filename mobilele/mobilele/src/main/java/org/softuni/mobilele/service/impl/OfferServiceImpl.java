...
public class OfferServiceImpl implements OfferService {
    ...
    public UUID createOffer(CreateOfferDTO createOfferDTO) {
        ...
        ModelEntity modelEntity = modelRepository.findById(createOfferDTO.modelId()).orElseThrow(() -> new IllegalArgumentException("Model with id " + createOfferDTO.modelId() + " not found!"));
